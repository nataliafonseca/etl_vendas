...
CREATE TABLE dm_clientes (
    ...
    cidade_cli    VARCHAR2(100) NOT NULL,
...
ALTER TABLE dm_fornecedores ADD CONSTRAINT dm_fornecedores_pk PRIMARY KEY ( id_forn );
...
ALTER TABLE ft_impontualidade ADD CONSTRAINT ft_impontualidade_pk PRIMARY KEY ( id_tempo,
                                                                                id_cliente );
...
ALTER TABLE ft_vendas ADD CONSTRAINT ft_vendas_pk PRIMARY KEY ( id_forn );

ALTER TABLE ft_impontualidade
    ADD CONSTRAINT ft_imp_dm_cli_fk FOREIGN KEY ( id_cliente )
        REFERENCES dm_clientes ( id_cliente );

ALTER TABLE ft_impontualidade
    ADD CONSTRAINT ft_imp_dm_tem_fk FOREIGN KEY ( id_tempo )
        REFERENCES dm_tempo ( id_tempo );

ALTER TABLE ft_vendas
    ADD CONSTRAINT ft_vendas_dm_fornecedores_fk FOREIGN KEY ( id_forn )
        REFERENCES dm_fornecedores ( id_forn );
